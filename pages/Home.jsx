...
const Home = ({ data }) => {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* Hero Section - With Subtle Gradient Noisy Elements */}
      <section className="min-h-screen flex flex-col items-center justify-center relative px-4 overflow-hidden">
        
        {/* Floating Gradient Noisy Elements */}
        <div className="absolute inset-0 pointer-events-none z-0">
          <div 
            className="absolute top-[20%] left-[15%] w-64 h-64 bg-indigo-500/10 rounded-full blur-[80px] animate-blob mix-blend-screen opacity-40"
            style={{ 
          ...
          ></div>
          <div 
            className="absolute bottom-[30%] right-[10%] w-80 h-80 bg-violet-600/10 rounded-full blur-[100px] animate-blob animation-delay-2000 mix-blend-screen opacity-30"
            style={{ 
          ...
          ></div>
          <div 
            className="absolute top-[50%] right-[35%] w-40 h-40 bg-indigo-400/5 rounded-full blur-[60px] animate-blob animation-delay-4000 mix-blend-screen"
            style={{ 
